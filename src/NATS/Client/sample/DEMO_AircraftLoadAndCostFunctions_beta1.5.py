...
if simulationInterface is None:
    ...
    print("Aircraft Book Value: " + str(safetyMetricsInterface.getAircraftBookValue('SWA1897')))
    print("Aircraft Cargo Worth: " + str(safetyMetricsInterface.getCargoWorth('SWA1897')))
    print("Aircraft Passenger Load Factor: " + str(safetyMetricsInterface.getPassengerLoadFactor('SWA1897')))
