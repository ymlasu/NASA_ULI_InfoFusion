...
class NATS_MonteCarlo_Interface:
    ...
    def getNATSEntityInterface(self):
        return self.entityInterface
    
    def getNATSPilotInterface(self):
        return self.pilotInterface  
    
    def getNATSControllerInterface(self):
    ...
    def setValue(self, val, var_name, fpindex):        
        ...
        if var_name == 'latitude':
            ...
            cI = self.getNATSControllerInterface()
