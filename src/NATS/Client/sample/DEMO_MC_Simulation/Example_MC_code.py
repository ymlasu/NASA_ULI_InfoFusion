...
'''Usage 1: args = [ac_list,time_pause,var_name].
            ...
            getValue() in NATS_MonteCarlo_Interface.py'''     
...
'''Usage 3: Another example for pilot and controller action. 
            ...
            @1: args_dict variable in this file and NATS_MonteCarlo_Interface.py.
            @2: write new code similar to one below to input it to MC parser. 
            @3: add the variable in setValue( ) function in NATS_MonteCarlo_Interface.py'''
