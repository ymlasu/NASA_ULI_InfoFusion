# This sample program demonstrates Tactical Weather Avoidance
#
# Oliver Chen
# 01.11.2019
#
...
if simulationInterface is None:
    ...
    weatherInterface.setTacticalWeatherAvoidance("LOSHN", 100.0)
    weatherInterface.setTacticalWeatherAvoidance("TOTIE", 200.0)
...
copyfile("../NATS_Server/" + output_filename_before, "../NATS_Server/" + planned_dirname + "/" + output_filename_before)
copyfile("../NATS_Server/" + output_filename_after, "../NATS_Server/" + planned_dirname + "/" + output_filename_after)
