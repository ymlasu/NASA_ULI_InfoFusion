...
if (env_NATS_CLIENT_HOME is None) :
    str_env_NATS_CLIENT_HOME = ""
else :
    str_env_NATS_CLIENT_HOME = env_NATS_CLIENT_HOME + "/"

classpath = str_env_NATS_CLIENT_HOME + "dist/nats-client.jar"
classpath = classpath + ":" + str_env_NATS_CLIENT_HOME + "dist/nats-shared.jar"
classpath = classpath + ":" + str_env_NATS_CLIENT_HOME + "dist/json.jar"
classpath = classpath + ":" + str_env_NATS_CLIENT_HOME + "dist/rmiio-2.1.2.jar"
classpath = classpath + ":" + str_env_NATS_CLIENT_HOME + "dist/commons-logging-1.2.jar"
