...
# 03.21.2019
#
# This program demonstrates Administrator operations.
#
# The program logs into NATS as Administrator.
# The user loads aircraft flight plan data from TRX file.
...
if simulationInterface is None:
    ...
    aircraftInterface.load_aircraft("share/tg/trx/TRX_DEMO_beta1.0_10rec.trx", "share/tg/trx/TRX_DEMO_beta1.0_10rec_mfl.trx")
