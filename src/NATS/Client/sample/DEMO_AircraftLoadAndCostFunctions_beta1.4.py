...
if simulationInterface is None:
    ...
    print("Aircraft Book Value: " + str(aircraft.getAircraftBookValue()))
    print("Aircraft Cargo Worth: " + str(aircraft.getCargoWorth()))
    print("Aircraft Passenger Load Factor: " + str(aircraft.getPassengerLoadFactor()))

    aircraft.setAircraftBookValue(5.6)
    aircraft.setCargoWorth(1.2)
    aircraft.setPassengerLoadFactor(0.72)
    ...
    fileName = "DEMO_Gate_To_Gate_SFO_PHX_beta1.2_" + str(millis) + ".csv"
